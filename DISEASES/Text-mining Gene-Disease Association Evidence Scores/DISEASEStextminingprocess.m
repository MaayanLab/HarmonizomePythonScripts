...
gene_atb.edges = edgesinit(641618, [], 'GeneSym', [], 'Ensemble Acc', [], [], [], 'Disease', [], 'Disease Ontology ID', [], [], true, []);



% read file
fid = fopen('input/human_disease_textmining_full_20150202.tsv', 'r');
...
save('input/gene_disease_jensentextmining_unprocessed_20150202.mat', '-struct', 'gene_atb');
%}
gene_atb = load('input/gene_disease_jensentextmining_unprocessed_20150202.mat', '-mat', 'edges');
