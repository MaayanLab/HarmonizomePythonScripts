...
gene_atb.edges = edgesinit(1231659, [], 'GeneSym', [], 'Ensemble Acc', [], [], [], 'Tissue/Cell Type', [], 'BTO', [], [], true, []);



% read file
fid = fopen('input/human_tissue_textmining_full_20150202.tsv', 'r');
...
save('input/gene_tissue_jensentextmining_unprocessed_20150202.mat', '-struct', 'gene_atb');
%}
gene_atb = load('input/gene_tissue_jensentextmining_unprocessed_20150202.mat', '-mat', 'edges');
