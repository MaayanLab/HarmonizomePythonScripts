...
gene_atb.edges = edgesinit(5714575, [], 'GeneSym', [], 'Ensemble Acc', [], [], [], 'Tissue/Cell Type', [], 'BTO', [], [], true, []);



% read file
fid = fopen('input/human_tissue_experiments_full_20150202.tsv', 'r');
...
% discard duplicate edges (retain the edge with the highest score), 2462068
% edges remaining
gene_atb.edges = edgesunique(gene_atb.edges);

save('input/gene_tissue_jensenexpts_unprocessed_20150202.mat', '-struct', 'gene_atb');
%}
gene_atb = load('input/gene_tissue_jensenexpts_unprocessed_20150202.mat', '-mat', 'edges');
