...
gene_atb.edges = edgesinit(551560, [], 'GeneSym', [], 'Ensemble Acc', [], [], [], 'Cellular Component', [], 'GO', [], [], true, []);



% read file
fid = fopen('input/human_compartment_knowledge_full_20150202.tsv', 'r');
...
% discard duplicate edges (retain the edge with the highest score), 329933
% edges remaining
gene_atb.edges = edgesunique(gene_atb.edges);

save('input/gene_compartment_jensencurated_unprocessed_20150202.mat', '-struct', 'gene_atb');
%}
gene_atb = load('input/gene_compartment_jensencurated_unprocessed_20150202.mat', '-mat', 'edges');
