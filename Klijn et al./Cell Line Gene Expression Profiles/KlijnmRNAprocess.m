...
gene_atb.cm = cminit(26094, 675, [], 'GeneID', [], [], [], 'GeneID', [], 'CellLine', [], 'Tissue', [], [], []);
...
% read data
fid = fopen('input/Data1_geneexpression/140331_VSDexport.txt', 'r');
...
gene_atb.cm.matrix = dlmread('input/Data1_geneexpression/140331_VSDexport.txt', '\t', 1, 0);
...
% THROWS AWAY NEARLY HALF OF THE GENES!
gene_atb.cm.matrix = gene_atb.cm.matrix - min(gene_atb.cm.matrix(:));
...
attribute = 'cellline';
filesuffix = 'klijn_rnaseq_20150415';
