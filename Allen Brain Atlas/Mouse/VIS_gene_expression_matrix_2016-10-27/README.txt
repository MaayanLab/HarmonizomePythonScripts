...
RNA sequencing data of single cells isolated from mouse primary visual cortex.

The data set includes 8329 single cells collected from various cortical layers of primary visual cortex.
...
Sample information (columns-samples.csv)
	rnaseq_profile_id
